...
vim.keymap.set( 'n', '<leader>fe', '<cmd>Telescope file_browser path=%:p:h select_buffer=true<cr>', { desc = "Find Journal" })
vim.keymap.set( 'n', '<leader>fE', '<cmd>Telescope file_browser<cr>', { desc = "Find Journal" })
